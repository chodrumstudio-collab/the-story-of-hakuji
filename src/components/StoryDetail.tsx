...
혼자 남겨진 하쿠지는 절망과 죄책감에 시달렸다. 그는 자신의 문신(罪人, 죄인)을 보며 범죄자로서의 낙인을 평생 짊어지게 되었다.`,
  ...
  2: {
    ...
    content: `거리에서 다른 무술 도장과 싸움을 벌이던 하쿠지. 그때 케이조라는 사람이 그를 발견했다.
...
눈 내리는 밤, 피로 얼룩진 하쿠지는 무릎을 꿇었다. "코유키... 미안해. 약속... 지키지 못했어."`,
  ...
  6: {
    title: 'Ch.6 아카자의 탄생',
    content: `절망에 빠진 하쿠지 앞에 무잔이 나타났다. 혈귀의 시조는 그에게 손을 내밀었다.

"강해지고 싶지 않나? 영원히 강해져서, 다시는 아무도 잃지 않도록."

무잔의 피를 받은 하쿠지는 혈귀가 되었다. 하지만 그 대가로 그는 모든 인간으로서의 기억을 잃었다.
...
아카자는 스스로를 파괴하기로 선택했다. 혈귀로서가 아닌, 하쿠지로서 죽기 위해.
